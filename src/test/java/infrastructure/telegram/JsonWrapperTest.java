...
public class JsonWrapperTest {
    ...
    public void formatMessageRequest_withKeyboard() {
        ...
        assertEquals("{\"chat_id\":12345,\"text\":\"hello world\",\"reply_markup\":\"{\\\"inline_keyboard\\\":[[{\\\"text\\\":\\\"Button 1\\\",\\\"callback_data\\\":\\\"data1\\\"},{\\\"text\\\":\\\"Button 2\\\",\\\"callback_data\\\":\\\"data2\\\"}]]}\",\"parse_mode\":\"HTML\",\"disable_web_page_preview\":true}", req);
    }
    ...
    public void formatMessageRequest() {
        ...
        assertEquals("{\"chat_id\":12345,\"text\":\"hello world\",\"parse_mode\":\"HTML\",\"disable_web_page_preview\":true}", req);
    }
    ...
    public void deserializeUpdates() {
        ...
        assertEquals(123456789, updates.get(0).message.sender);
